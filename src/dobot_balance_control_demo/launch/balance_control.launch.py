    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument(
                ...
                description="姿态平衡演示 YAML 配置文件路径。 / Path to the attitude balance demo YAML configuration file.",
            ),
            DeclareLaunchArgument(
                "grpc_addr",
            ...
            DeclareLaunchArgument(
                "record_plot",
                default_value="false",
                description="是否记录姿态数据并在退出时生成 CSV/HTML 曲线结果。 / Whether to record attitude data and generate CSV/HTML curve results on exit.",
            ),
            ExecuteProcess(
                cmd=[
                    "python",
