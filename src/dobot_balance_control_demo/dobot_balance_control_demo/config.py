...
def load_yaml(path: str) -> dict[str, Any]:
    """Load a YAML file; empty files are treated as empty dictionaries."""
...
def resolve_path(path_value: str | None, config_file: str | None = None) -> str | None:
    """Resolve project-relative paths from source, install, or workspace roots."""
    if not path_value:
        return None
...
def ensure_valid_cyclonedds_uri(config_file: str | None = None) -> str | None:
    """Keep CycloneDDS from failing because of a stale copied file URI."""
